...
function parseOptions(a, b) {
  ...
  return Object.assign({
    ...
    idle_timeout    : o.idle_timeout || ('searchParams' in url && parseInt(url.searchParams.get('idle_timeout'), 10)) || env('PGIDLE_TIMEOUT') || warn(o.timeout),
    connect_timeout : o.connect_timeout || ('searchParams' in url && parseInt(url.searchParams.get('connect_timeout'), 10)) || env('PGCONNECT_TIMEOUT') || 30,
